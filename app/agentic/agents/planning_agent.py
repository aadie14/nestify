"""Merged planning agent for cost optimization and platform selection."""
...
class PlanningAgent:
    """Estimate resource cost and select a deployment platform."""
    ...
    async def optimize(
        ...
        for config in self._candidate_configs():
            ...
            matrix.append({"config": config, "benchmark": benchmark, "monthly_cost_usd": monthly_cost})
